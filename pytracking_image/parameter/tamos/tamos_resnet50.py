...
def parameters():
    ...
    params.net = NetWithBackbone(net_path='/home/mbzirc/Downloads/AhsanBB/Dataset_Paper/Codes/Pytracking_New/pytracking/pytracking/networks/tamos_resnet50.pth.tar', use_gpu=params.use_gpu)
