...
def parameters():
    ...
    deep_feat = deep.ATOMResNet18(net_path='/home/mbzirc/Downloads/AhsanBB/Dataset_Paper/Codes/Pytracking_New/pytracking/pytracking/networks/atom_default.pth', output_layers=['layer3'], fparams=deep_fparams, normalize_power=2)
