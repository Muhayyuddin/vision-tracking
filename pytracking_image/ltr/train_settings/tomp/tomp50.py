...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler([ got10k_train], [1],
                                        samples_per_epoch=8000, max_gap=30,
    ...
    dataset_val = sampler.DiMPSampler([got10k_val], [1], samples_per_epoch=1000,
                                      max_gap=30, num_test_frames=settings.num_test_frames,
