...
class EnvSettings:
    def __init__(self):
        ...
        self.network_path = '/home/mbzirc/Downloads/AhsanBB/Dataset_Paper/Codes/Pytracking_New/pytracking/Checkpoints/checkpoints/ltr/bbreg/atom'
